...
class question4 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        perguntasTextViews.text = questions[4].Question
        r1_button.setText(questions[4].Answ1)
        r0_button.setText(questions[4].Answ0)
        r2_button.setText(questions[4].Answ2)

        r0_button.setOnClickListener{
            data[0].Score += 0
            nav.navigate(R.id.action_question4_to_question5)
        }
